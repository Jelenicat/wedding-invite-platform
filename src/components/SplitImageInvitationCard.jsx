        ...
        {infoItems.length > 0 && (
          <div className="split-image-program">
            {infoItems.map((item, index) => (
              ...
              >
                <span className="split-image-program-label">{item.label}</span>
                <span className="split-image-program-value">{item.value}</span>
              </div>
            ))}
          </div>
        )}
        ...
        {details.dressCodePalette?.length > 0 && (
          <div className="split-image-extra">
            ...
            {details.dressCodeNote && (
              <p className="split-image-section-note">{details.dressCodeNote}</p>
            )}
          </div>
        )}
