...
function FloralCountdown({ targetDate }) {
  ...
  if (!timeLeft) {
    return (
      <section className="floral-countdown-section">
        <div className="floral-countdown-inner">
          <p className="floral-countdown-kicker">Dan venčanja je stigao</p>
        </div>
      </section>
    );
  }
  ...
  return (
    ...
    >
      <div className="floral-countdown-inner">
        <p className="floral-countdown-kicker">Do venčanja je ostalo</p>

        <div className="floral-countdown-divider" />

        <div className="floral-countdown">
          {items.map((item) => (
            <div key={item.label} className="floral-countdown-item">
        ...
        <p className="floral-countdown-note">
