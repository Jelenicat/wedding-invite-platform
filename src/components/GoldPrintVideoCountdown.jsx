...
function GoldPrintVideoCountdown({
  brideName,
  groomName,
  details = {},
  script = "cyrillic",
  ...
  return (
    <section className="goldprint-video-countdown-section">
      <motion.div
        className="goldprint-video-countdown-shell"
        initial={{ opacity: 0, y: 28 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.25 }}
        transition={{ duration: 0.9, ease: [0.22, 1, 0.36, 1] }}
      >
        <p className="goldprint-video-countdown-kicker">
          {brideName} & {groomName}
        </p>

        <h2 className="goldprint-video-countdown-title">
          {timeLeft.finished ? labels.finished : labels.title}
        </h2>

        <div className="goldprint-video-countdown-ornament">
          <span />
          <em>♡</em>
          <span />
        </div>

        <div className="goldprint-video-countdown-grid">
          <div className="goldprint-video-countdown-item">
        ...
        {showCalendarButton && (
          <div className="goldprint-video-countdown-calendar-box">
            <button
              type="button"
              className="goldprint-video-countdown-calendar-btn"
            ...
            <p className="goldprint-video-countdown-calendar-hint">
              {labels.calendarHint}
            </p>
          </div>
        )}
...
export default GoldPrintVideoCountdown;