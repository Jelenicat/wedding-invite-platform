        ...
        {infoItems.length > 0 && (
          <div className="envelope-program">
            {infoItems.map((item, index) => (
              <div className="envelope-program-row" key={`${item.label}-${index}`}>
                <span className="envelope-program-label">{item.label}</span>
                <span className="envelope-program-value">{item.value}</span>
              </div>
            ))}
          </div>
        )}
        ...
        {details.dressCodePalette?.length > 0 && (
          <div className="envelope-extra">
            ...
            {details.dressCodeNote && (
              <p className="envelope-section-note">{details.dressCodeNote}</p>
            )}
          </div>
        )}
