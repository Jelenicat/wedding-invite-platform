        ...
        {infoItems.length > 0 && (
          <div className="photo-script-program">
            {infoItems.map((item, index) => (
              ...
              >
                <span className="photo-script-program-label">{item.label}</span>
                <span className="photo-script-program-value">{item.value}</span>
              </div>
            ))}
          </div>
        )}
        ...
        {details.dressCodePalette?.length > 0 && (
          <div className="photo-script-extra">
            ...
            {details.dressCodeNote && (
              <p className="photo-script-section-note">{details.dressCodeNote}</p>
            )}
          </div>
        )}
