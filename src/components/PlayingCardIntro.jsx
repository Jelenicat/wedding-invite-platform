...
function PlayingCardIntro({
  ...
  return (
    <section
      className="pc-intro"
      aria-label="Wedding playing card intro"
    >
      ...
      >
        ...
        >
          <span className="pc-corner-initial">
            {brideInitial}
          </span>

          <span className="pc-corner-heart">
            ♥
          </span>
        </motion.div>
        ...
        >
          <div className="pc-name pc-name-bride">
            {brideName}
          </div>
          ...
          <div className="pc-name pc-name-groom">
            {groomName}
          </div>

          <div className="pc-invite-text">
            vas pozivaju na venčanje
          </div>
        </motion.div>
        ...
        >
          ...
          <div
            className="pc-script-art"
            aria-hidden="true"
          >
            <div className="pc-script-line pc-script-line-one">
              Lucky in
            </div>

            <div className="pc-script-line pc-script-line-two">
              Love
            </div>
          </div>
        </motion.div>
        ...
        >
          <span className="pc-button-heart">
            ♥
          </span>
